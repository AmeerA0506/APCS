// (Do not) Consume Arsenic:: Ameer Alnasser, Corina Chen + a happy shoutout to Piazza
// APCS pd 6
// HW 35 :: Refactoring our code
// 2021-11-15
// Time: 0.5 hours
...
- helper functions can be helpful in recursing through the functions where we
  ...
  helper functions
- Utilities isn't necessary

QCC:
- Is it illegal to do what we did with helper functions? Does that count as
  cheating?
*/
